...
// The latest Kirigami version available on Ubuntu Touch currently is 2.5
// because the distro is still based on Focal (20.04) for now. Plan is to move to
// noble (24.04) in mid 2024
